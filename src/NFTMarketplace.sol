...
contract NFTMarketplace is NFT {
    ...
    // view says this function only reads data. 
    // So it doesn't cost gas. Only writing data onto the blockchain costs significantly more gas.
       return listingPrice;
    }
    ...
    function fetchItemsListed() public view returns (MarketItem[] memory) {
        ...
        for (uint i=0; i<totalItemCount; i+=1) {
